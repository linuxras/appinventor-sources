...
public interface OdeMessages extends Messages, AutogeneratedOdeMessages {
  ...
  @Description("Switch to enable Dark Mode Theme")
  String enableDarkModeTheme();

  @DefaultMessage("Disable Dark Mode")
  @Description("Switch to disable Dark Mode Theme")
  String disableDarkModeTheme();
  ...
  @DefaultMessage("App Package:")
  @Description("Label for the project app package input text box")
  String projectPackageNameLabel();

  @DefaultMessage("Use Default Package")
  @Description("Label for the default flag project app package input text box")
  String projectDefaultPackageNameLabel();
  ...
  @DefaultMessage("App Package name may contain uppercase or lowercase letters ('A' through 'Z'), numbers," +
      " and underscores ('_'). It must have at least three segments (two or more dots). However, individual "+
      "package name parts may only start with letters. ")
  @Description("Error message when package name does not start with a letter or contains a " +
      "character that is not a letter, number, underscore or does not contain at least two segments.")
  String malformedPackageNameError();
